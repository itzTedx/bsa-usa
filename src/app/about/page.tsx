    ...
    <>
      ...
      <div className="max-w-5xl mx-auto space-y-4 my-12">
        <h5 className="font-bold text-xl">
          ...
          People, Buildings, and Better Me et
        </h5>
        <p>
        ...
        <p>
          ...
          each project we undertake, we strive to leave a lasting legacy of
          responsible construction, enriching communities, and fostering a
